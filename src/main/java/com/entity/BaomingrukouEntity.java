...
public class BaomingrukouEntity<T> implements Serializable {
	 ...
	 * 设置：详说明
	 */
	public void setXiangshuoming(String xiangshuoming) {
		this.xiangshuoming = xiangshuoming;
	}
	/**
	 * 获取：详说明
	 */
	public String getXiangshuoming() {
		return xiangshuoming;
	}
	/**
	 * 设置：封面
	 */
