 ...
 */
public class KaoshengbaomingVO  implements Serializable {
	...
	public void setChengjiziliao(String chengjiziliao) {
		this.chengjiziliao = chengjiziliao;
	}
	
	/**
	 * 获取：成绩资料
	 */
	public String getChengjiziliao() {
		return chengjiziliao;
	}
