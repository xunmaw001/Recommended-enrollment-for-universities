  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="账号" class="input" v-if="tableName=='kaosheng'">
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='kaosheng'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='kaosheng'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='kaosheng'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      if((!this.ruleForm.zhanghao) && `kaosheng` == this.tableName){
        this.$message.error(`账号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `kaosheng` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `kaosheng` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if((!this.ruleForm.xingming) && `kaosheng` == this.tableName){
        this.$message.error(`姓名不能为空`);
        return
      }
      if(`kaosheng` == this.tableName && this.ruleForm.nianling&&(!this.$validate.isIntNumer(this.ruleForm.nianling))){
        this.$message.error(`年龄应输入整数`);
        return
      }
      if(`kaosheng` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
