<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="名额" prop="minge">
          <el-input v-model="ruleForm.minge" 
              placeholder="名额" clearable  :readonly="ro.minge"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="详说明" prop="xiangshuoming">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xiangshuoming" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiangshuoming" label="详说明" prop="xiangshuoming">
                    <span v-html="ruleForm.xiangshuoming"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fabushijian = true;
          ...
          if(o=='xiangshuoming'){
            this.ruleForm.xiangshuoming = obj[o];
	    this.ro.xiangshuoming = true;
            continue;
          }
          if(o=='fengmian'){
	...
	this.ruleForm.xiangshuoming = this.ruleForm.xiangshuoming.replace(reg,'../../../ssmf55y5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `baomingrukou/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.baomingrukouCrossAddOrUpdateFlag = false;
						 this.parent.search();
